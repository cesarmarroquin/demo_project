...
urlpatterns = [
    ...
    url(r'^classes/(?P<pk>\d+)/events$', ClassEventList.as_view(), name='school_class_event_list'),
    url(r'^classes/(?P<pk>\d+)/fees$', ClassFeeList.as_view(), name='school_class_fee_list'),
